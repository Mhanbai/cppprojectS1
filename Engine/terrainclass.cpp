...
bool TerrainClass::InitializeBuffers(ID3D11Device* device)
{
	...
	for (j = 0; j<(m_terrainHeight - 1); j++)
	{
		for (i = 0; i<(m_terrainWidth - 1); i++)
		{
			...
			vertices[index].position = D3DXVECTOR3(m_heightMap[index3].x + xOffset, m_heightMap[index3].y + yOffset, m_heightMap[index3].z + zOffset);
			...
			vertices[index].position = D3DXVECTOR3(m_heightMap[index4].x + xOffset, m_heightMap[index4].y + yOffset, m_heightMap[index4].z + zOffset);
			...
			// Bottom left.
			vertices[index].position = D3DXVECTOR3(m_heightMap[index1].x + xOffset, m_heightMap[index1].y + yOffset, m_heightMap[index1].z + zOffset);
			...
			vertices[index].position = D3DXVECTOR3(m_heightMap[index2].x + xOffset, m_heightMap[index2].y + yOffset, m_heightMap[index2].z + zOffset);
