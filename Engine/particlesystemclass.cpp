...
void ParticleSystemClass::EmitParticles(float frameTime)
{
	...
	if ((emitParticle == true) && (m_currentParticleCount < (m_maxParticles - 1)))
	{
		...
		//positionX = 0.0f + (((float)rand() - (float)rand()) / RAND_MAX) * m_particleDeviationX;
		//positionY = 0.0f + (((float)rand() - (float)rand()) / RAND_MAX) * m_particleDeviationY;
		//positionZ = 0.0f + (((float)rand() - (float)rand()) / RAND_MAX) * m_particleDeviationZ;
		positionX = 0.0f;
		positionY = 0.0f;
		positionZ = 0.0f;
